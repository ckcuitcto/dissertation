...
-- ----------------------------
INSERT INTO `faculties` VALUES (1, 'Công nghệ thông tin', NULL, NULL);
INSERT INTO `faculties` VALUES (2, 'Quản trị kinh doanh', NULL, NULL);
INSERT INTO `faculties` VALUES (3, 'Công nghệ thực phẩm', NULL, NULL);
INSERT INTO `faculties` VALUES (4, 'Điện - Điện tử', NULL, NULL);
INSERT INTO `faculties` VALUES (5, 'Kỹ thuật công trình', NULL, NULL);
INSERT INTO `faculties` VALUES (6, 'Cơ khí', NULL, NULL);
INSERT INTO `faculties` VALUES (7, 'Design', NULL, NULL);

-- ----------------------------
-- Table structure for mark_times
-- ----------------------------
DROP TABLE IF EXISTS `mark_times`;
CREATE TABLE `mark_times`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `mark_time_start` date NOT NULL,
  `mark_time_end` date NOT NULL,
  `semester_id` int(10) UNSIGNED NOT NULL,
  `role_id` int(10) UNSIGNED NOT NULL,
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `mark_times_semester_id_foreign`(`semester_id`) USING BTREE,
  INDEX `mark_times_role_id_foreign`(`role_id`) USING BTREE,
  CONSTRAINT `mark_times_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `mark_times_semester_id_foreign` FOREIGN KEY (`semester_id`) REFERENCES `semesters` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `migrations` VALUES (19, '2018_04_13_123754_create_mark_times_table', 1);
...
INSERT INTO `students` VALUES (3, 'CD51402222', 1, NULL, NULL);
INSERT INTO `students` VALUES (4, 'DH51400999', 2, NULL, NULL);
INSERT INTO `students` VALUES (5, 'DH51400888', 4, NULL, NULL);
INSERT INTO `students` VALUES (6, 'DH51400777', 4, NULL, NULL);
...
CREATE TABLE `users`  (
  ...
  INDEX `users_faculty_id_foreign`(`faculty_id`) USING BTREE,
  CONSTRAINT `users_faculty_id_foreign` FOREIGN KEY (`faculty_id`) REFERENCES `faculties` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('AD123122', 'V . I . P', 'huynhjduc248@gmail1.com', '$2y$10$19bB1vjuEwCmXzaUw8JUwOiUKT9zv.56DXvydbFotU6HzEhWth/IC', NULL, NULL, NULL, NULL, NULL, NULL, 6, NULL, NULL, NULL);
INSERT INTO `users` VALUES ('CD51402222', 'Sinh vien 1', 'CD51402222@gmail.com', '$2y$10$t079tyM9Bo6/DUR3JmAcJOBlPyEhUUHhSzGzEnl2EmmNgQCfvMQY.', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL);
INSERT INTO `users` VALUES ('CT123123', 'Giao vien han', 'GV1241325@gmail1.com', '$2y$10$4d8zl.ujtFfIloTaYQ9.E.y/uwxudXJDkuuWyqGyVtyi5BdqmCHVS', NULL, NULL, NULL, NULL, NULL, NULL, 5, NULL, NULL, NULL);
INSERT INTO `users` VALUES ('DH51400250', 'Thai Duc', 'thducit@gmail.com', '$2y$10$H7US/TetOGLTRVqHqNUx/ONL/4dmklKcoxJjfZnbrQOgzujgTpyMS', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL);
INSERT INTO `users` VALUES ('DH51400251', 'Thai Duc 1', 'thducit1@gmail.com', '$2y$10$ISAibxb0/FQeIlbNdn4lweTldjtS8QidKYjrBu6WdYP/GL.sPo0OK', NULL, NULL, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL);
INSERT INTO `users` VALUES ('DH51400777', 'Sinh vien 4', 'DH51400777@gmail.com', '$2y$10$jrS46YX3gizxHIu2sTzBV.N3Xygzc25d3a03cMjgQ6..F73tefu16', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL);
INSERT INTO `users` VALUES ('DH51400888', 'Sinh vien 3', 'DH51400888@gmail.com', '$2y$10$Ukw7l9DnLCh27FJhR6DJROx/aWCfSLztSPyYl7JsxNmwun8LL7Abm', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL);
INSERT INTO `users` VALUES ('DH51400999', 'Sinh vien 2', 'DH51400999@gmail.com', '$2y$10$NmXDIUIqpLh6FKWjRvm0hO9hTYqDkvbOiBfqXRzXMo16ZC0oi/xbS', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL);
INSERT INTO `users` VALUES ('GV123123', 'Cố vấn học tập', 'GV123123@gmail.com', '$2y$10$KUr7m.pL5YbD91lddmeoou4OEKx6ti6qLUbUdvWPMqbSFUc1dwt3u', NULL, NULL, NULL, NULL, NULL, NULL, 3, NULL, NULL, NULL);
INSERT INTO `users` VALUES ('GV124124', 'Ban chủ nhiệm khoa', 'GV122223@gmail1.com', '$2y$10$ya3QXTH0fw2BE8ThbzWdrOyGytzAzecV8yH.4VC81gqVUvWFyMZZ2', NULL, NULL, NULL, NULL, NULL, NULL, 4, NULL, NULL, NULL);
INSERT INTO `users` VALUES ('GV124125', 'Cố vấn học tập', 'GV1241225@gmail1.com', '$2y$10$PfTwAuwtdQDGbMaul7//u.YJ8Fs8iXaLTmBd0cqWCSJZeh/StfDNC', NULL, NULL, NULL, NULL, NULL, NULL, 3, NULL, NULL, NULL);
