...
//            I. Ý thức tham gia học tập (0 – 20 điểm)  id = 1
            [
                ...
                "detail" => null,
                "mark_range_from" => null, "mark_range_to" => null, "parent_id" => null, "proof" => null,
                'level' => '1'
            ], [
            ...
            [
                ...
                "mark_range_display" => null,
                "detail" => null,
                "mark_range_from" => null, "mark_range_to" => null, "parent_id" => 3, "proof" => null,
                'level' => '2'
            ],
...
//            a.	Ý thức học tập id = 6
            ...
            [
                ...
                "detail" => null,
                "mark_range_from" => 5, "mark_range_to" => null, "parent_id" => 6, "proof" => null,
                'level' => '3'
            ],
            [
            ...
            [
                ...
                "detail" => null,
                "mark_range_from" => "-2", "mark_range_to" => null, "parent_id" => 6, "proof" => null,
                'level' => '3'
            ],
            ...
            [
                ...
                "detail" => null,
                "mark_range_from" => -3, "mark_range_to" => null, "parent_id" => 8, "proof" => null,
                'level' => '3'
            ],
...
//            II. Ý thức chấp hành nội quy, quy chế, quy định trong nhà trường (0 – 25 điểm) id = 2
            ...
            [
                ...
                "mark_range_display" => "-5 điểm",
                "detail" => null,
                "mark_range_from" => "-5", "mark_range_to" => null, "parent_id" => 9, "proof" => null,
                'level' => '3'
            ],
            ...
            [
                ...
                "detail" => null,
                "mark_range_from" => "-10", "mark_range_to" => null, "parent_id" => 9, "proof" => null,
                'level' => '3'
            ],
            ...
            [
                ...
                "mark_range_display" => "2 điểm",
                "detail" => null,
                "mark_range_from" => 2, "mark_range_to" => null, "parent_id" => 10, "proof" => null,
                'level' => '3'
            ],
            ...
            [
                ...
                "mark_range_display" => "5 điểm",
                "detail" => null,
                "mark_range_from" => 5, "mark_range_to" => null, "parent_id" => 10, "proof" => null,
                'level' => '3'
            ],
            ...
            [
                ...
                "mark_range_display" => "5 điểm",
                "detail" => null,
                "mark_range_from" => 5, "mark_range_to" => null, "parent_id" => 3, "proof" => null,
                'level' => '3'
            ],
            ...
            [
                ...
                "detail" => null,
                "mark_range_from" => 15, "mark_range_to" => null, "parent_id" => 3, "proof" => null,
                'level' => '3'
            ],
            ...
            [
                ...
                "mark_range_display" => "10 điểm",
                "detail" => null,
                "mark_range_from" => 10, "mark_range_to" => null, "parent_id" => 4, "proof" => null,
                'level' => '3'
            ],
            ...
            [
                ...
                "mark_range_display" => "5 điểm",
                "detail" => null,
                "mark_range_from" => 5, "mark_range_to" => null, "parent_id" => 4, "proof" => null,
                'level' => '3'
            ],
            ...
            [
                ...
                "mark_range_display" => "10 điểm",
                "detail" => null,
                "mark_range_from" => 10, "mark_range_to" => null, "parent_id" => 4, "proof" => 1,
                'level' => '3'
            ],
            ...
            [
                ...
                "detail" => null,
                "mark_range_from" => 6, "mark_range_to" => 10, "parent_id" => 5, "proof" => 1,
                'level' => '3'
            ],
