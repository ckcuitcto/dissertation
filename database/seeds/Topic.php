...
class Topic extends Seeder
{
    ...
    public function run()
    {
        DB::table('topics')->insert([
            ...
            ['title' => 'V. Ý thức và kết quả tham gia công tác cán bộ lớp, các đoàn thể, tổ chức khác trong nhà trường hoặc sinh viên đạt được thành tích đặc biệt trong học tập, rèn luyện (0 – 10 điểm)', 'max_score' => '10'],
        ]);
    }
}
