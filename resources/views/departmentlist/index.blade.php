...
{{--@section('content')--}}
    {{--<main class="app-content">--}}
        {{--<div class="app-title">--}}
            {{--<div>--}}
                {{--<h1><i class="fa fa-file-text-o"></i> Danh sách các Phòng ban</h1>--}}
                {{--<p>Trường Đại học Công nghệ Sài Gòn</p>--}}
            {{--</div>--}}
            {{--<ul class="app-breadcrumb breadcrumb side">--}}
                {{--<li class="breadcrumb-item"><a href="#"><i class="fa fa-home fa-lg"></i></a></li>--}}
                {{--<li class="breadcrumb-item active"><a href="#"> Danh sách các Phòng ban</a></li>--}}
            {{--</ul>--}}
        {{--</div>--}}
        {{--<div class="row">--}}
            {{--<div class="col-md-12">--}}
                    ...
                    {{--<div class="tile-body">--}}
                        {{--<table class="table table-hover table-bordered" id="sampleTable">--}}
                            ...
                            {{--<tbody>--}}
                                {{--<tr>--}}
                                    {{--<td>Phòng đào tạo</td>--}}
                                    {{--<td><i class="fa fa-lg fa-edit" aria-hidden="true"> </i></td>--}}
                                    {{--<td><i class="fa fa-lg fa-trash-o" aria-hidden="true"> </i></td>--}}
                                {{--</tr>--}}
                            {{--</tbody>--}}
                        {{--</table>--}}
                        {{--<div class="row">--}}
                            {{--<div class="col-md-6">--}}
                                {{--<button data-toggle="modal" data-target="#myModal" class="btn btn-primary" id="btnAddFaculty" type="button"><i class="fa fa-pencil-square-o"                                          aria-hidden="true"></i>Thêm</button>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                {{--</div>--}}
                                ...
                                {{--<div class="col-md-12">--}}
                                    {{--<div class="form-group">--}}
                                        ...
                                        {{--<input class="form-control name" id="name" name="name" type="text" required--}}
                                               {{--aria-describedby="faculty" placeholder="Nhập tên phòng ban">--}}
