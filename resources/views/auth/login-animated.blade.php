@extends('layouts.app')
@section('content')
    <link href="{{ asset('animated_svg_avatar2/animated.css') }}" rel="stylesheet">
    <div class="container">
        <div class="row">
                            ...
                            <div class="svgContainer">
                                <div>
                                    <svg class="mySVG" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <g class="earR">
                                            <g class="outerEar">
                                                <circle fill="#DDF1FA" stroke="#3A5E77" stroke-width="2.5" cx="153"
                                                        cy="83" r="11.5"/>
                                        ...
                                        <g class="mouth">
                                            ...
                                            <g clip-path="url(#mouthMask)">
                                                <g class="tongue">
                                                    ...
                                                    <ellipse class="tongueHighlight" cx="100" cy="100.5" rx="3" ry="1.5"
                                                             opacity=".1" fill="#fff"/>
                                                </g>
                                            </g>
...
@endsection
@section('javascript')
    <script src="{{ asset('animated_svg_avatar2/TweenMax.min.js') }}"></script>
    <script src="{{ asset('animated_svg_avatar2/animated.js') }}"></script>
@stop
