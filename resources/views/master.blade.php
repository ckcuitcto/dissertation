...
<html lang="en">
  <head>
    ...
    <!-- Main CSS-->
    <link rel="stylesheet" type="text/css" href="html/docs/css/main.css">
    <!-- Font-icon css-->
  ...
  <body class="app sidebar-mini rtl">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.html">STU</a>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Đánh giá rèn luyện</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="page-form-evaluation.html"><i class="icon fa fa-circle-o"></i> Phiếu Đánh Giá</a></li>
            <li><a class="treeview-item" href="page-scores.html"><i class="icon fa fa-circle-o"></i> Tổng Điểm Cá Nhân</a></li>
            <li><a class="treeview-item" href="page-assessment-manage.html"><i class="icon fa fa-circle-o"></i> Quản lý đánh giá</a></li>
          </ul>
        </li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Tin tức</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="page-notifications.html"><i class="icon fa fa-circle-o"></i> Thông Báo</a></li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Góp ý</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="page-opinion.html"><i class="icon fa fa-circle-o"></i> Gửi ý kiến đóng góp</a></li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Hỗ Trợ Học Vụ</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="page-timetable.html"><i class="icon fa fa-circle-o"></i> Thời Khóa Biểu</a></li>
            ...
            <li><a class="treeview-item" href="page-tuition.html"><i class="icon fa fa-circle-o"></i> Học Phí</a></li>
          </ul>
        </li>
    ...
    <script src="html/docs/js/jquery-3.2.1.min.js"></script>
    <script src="html/docs/js/popper.min.js"></script>
    <script src="html/docs/js/bootstrap.min.js"></script>
    <script src="html/docs/js/main.js"></script>
    <!-- The javascript plugin to display page loading on top-->
    <script src="html/docs/js/plugins/pace.min.js"></script>
    <!-- Page specific javascripts-->
    <script type="text/javascript" src="html/docs/js/plugins/chart.js"></script>
