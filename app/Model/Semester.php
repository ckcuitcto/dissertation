...
class Semester extends Model
{
    ...
    protected $fillable = ['year_from','year_to','term','date_start_to_mark','date_end_to_mark','date_start_to_re_mark','date_end_to_re_mark','date_start_to_request_re_mark','date_end_to_request_re_mark'];
